...
@section('content')
<div class="container">
    <h2 class="fw-bold mb-4">👥 Riwayat Aktivitas Pengguna</h2>
    ...
    <div class="mb-3 d-flex gap-2">
        <a href="{{ route('log.user.export.pdf', request()->all()) }}" class="btn btn-outline-danger btn-sm">
            🧾 Export PDF
        </a>
    </div>
    <div class="table-responsive">
        <table class="table table-bordered align-middle text-center">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-muted text-center">Tidak ada aktivitas pengguna.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
